		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				ws.onmessage = function (event) {
					...
					var clientList = _this2.state.clientList;
					...
					if (message.event == 'keychange') {
						...
						_this2.setState({
							totalClicks: _this2.state.totalClicks + 1,
							clientList: clientList
						});
					}
			...
			value: function resetCounters() {
				var clientList = this.state.clientList.map(function (client) {
					client.clicks = 0;
					return client;
				});
				this.setState({
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(
						...
						null,
						'Antall klienter: ',
						Object.keys(this.state.clientList).length
					),
					React.createElement(
						'p',
						null,
					...
					React.createElement(
						'table',
						null,
						this.state.clientList.map(function (client) {
							return React.createElement(
								'tr',
								null,
								React.createElement(
					...
					React.createElement(
						...
						this.state.recording ? 'pause' : 'play'
					)
				);
			}
		}]);
